...
var MEDIA_STREAM_RENDERER_NEW_TAG = 'iosrtc:MediaStreamRendererNew';
...
var MEDIA_STREAM_TRACK_TAG = 'iosrtc:MediaStreamTrack';
var MEDIA_STREAM_TRACK_SET_LISTENER_TAG = 'iosrtc:MediaStreamTrackSetListener';
var MEDIA_STREAM_TRACK_SET_ENABLED_TAG = 'iosrtc:MediaStreamTrackSetEnabled';
var MEDIA_STREAM_TRACK_STOP_TAG = 'iosrtc:MediaStreamTrackStop';
 ...
 */
var
	debug = _dereq_('debug')(MEDIA_STREAM_TRACK_TAG),
...
function MediaStreamTrack(dataFromEvent) {
	...
	microsoftTeams.sendCustomMessage(MEDIA_STREAM_TRACK_SET_LISTENER_TAG, [this.id], onResultOK);
}
...
Object.defineProperty(MediaStreamTrack.prototype, 'enabled', {
	...
	set: function (value) {
		...
		this._enabled = !!value;
		microsoftTeams.sendCustomMessage(MEDIA_STREAM_TRACK_SET_ENABLED_TAG, [this.id, this._enabled]);
	}
});
...
MediaStreamTrack.prototype.stop = function () {
	...
	microsoftTeams.sendCustomMessage(MEDIA_STREAM_TRACK_STOP_TAG, [this.id]);
};
...
var RTCDTMF_SENDER_ERROR_TAG = 'iosrtc:RTCDTMFSender:ERROR';
...
var RTC_DATA_CHANNEL_ERROR_TAG = 'iosrtc:RTCDataChannel:ERROR';
...
var RTC_PEER_CONNECTION_ERROR_TAG = 'iosrtc:RTCPeerConnection:ERROR';
...
var GET_USER_MEDIA_ERROR_TAG = 'iosrtc:getUserMedia:ERROR';
